...
```bash
heroku buildpacks:add https://github.com/doanhoa93/heroku-buildpack-wkhtmltopdf.git
```
...
```bash
heroku buildpacks:add --index=1 https://github.com/doanhoa93/heroku-buildpack-wkhtmltopdf.git
```
